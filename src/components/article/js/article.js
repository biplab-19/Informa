...
$(document).on("click", ".menu a", function () {
        $(this).parent(".menu").siblings(".menu").removeClass("active");
        $(this).parent(".menu").siblings(".menu").children(".dropdown-content").removeClass("drop-content-active");
        $(this).parent(".menu").siblings(".menu").children("a").children("span").removeClass('triangle-down');
        $(this).parent(".menu").siblings(".menu").children("a").children("span").addClass('triangle-right');
...
$(document).on("click","#articlelistshowmore",function(){
    ...
    {
    $('#articlelistshowmore').css('display', 'none');
    }
