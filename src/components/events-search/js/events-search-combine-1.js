...
INFORMA.EventsViews = (function (window, $, namespace) {
    ...
    var EventsLists = $('.events-search'),
        ...
        PageNo = 2,
        //methods
        init, RenderOnLoad, GetAjaxData, SwitchEvents, RenderLoadEvents, LoadMoreEvents, SetCalendarEvents, RenderParticularMonth, RenderChange, GetEventData, GetDefaultEventData, SetListEvents, NoEventsFound, EqualHeight, CheckCount, MoreEventsFunc, ListChangeEvents, CheckEvents, UnbindEvent, disabledEvent, SetLoadMoreEvents, isDev;
