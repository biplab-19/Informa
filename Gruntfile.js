        ...
        concat: {
            ...
            prod: {
                files: {
                    ...
                    '<%= config.dist %>/unminified/Static/css/tmt-newco.css': ['<%= config.tmp %>/Static/css/tmt-newco.css'],
